...
Дистрибутив беру Ubuntu 22.04 (с версии 20.04 слишком много проблем с репозиториями, разворачивал на ней).
```yaml
...
но когда стал перекидывать на балансировщика -  возникли проблемы из-за того, что группа была либо на одном балансировщике, либо на другом!
...
Хорошо
![11-04-01](hhttps://github.com/mkuliaev/netology-code-devops-diplom-yandexcloud/blob/main/png_diplom/grafana_brouw.png)
