...
Дистрибутив беру Ubuntu 22.04 (с версии 20.04 слишком много проблем с репозиториями при установке k8s, разворачивал на ней).
```yaml
...
Теперь пришло время разобраться с нодами.
...
но когда стал перекидывать на балансировщика -  , возникли проблемы из-за того, что две группы использовали одинаковые IP-адреса. Звучит логично, но сообразил не сразу.
...
Хорошо
![11-04-01](https://github.com/mkuliaev/netology-code-devops-diplom-yandexcloud/blob/main/png_diplom/app_0.4.9.png)
![11-04-01](https://github.com/mkuliaev/netology-code-devops-diplom-yandexcloud/blob/main/png_diplom/k8s_0.4.9.png)
Гифочка
